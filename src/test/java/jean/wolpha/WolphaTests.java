...
//        List<Character> chars = WolphaSymbol.DIGITS;
//        chars.addAll(WolphaSymbol.BINARY_OPERATORS);
//        chars.addAll(WolphaSymbol.UNARY_OPERATORS);
//        chars.addAll(WolphaSymbol.CONSTANT_STARTERS);
//        chars.addAll(WolphaSymbol.FUNCTION_STARTERS);
//        chars.addAll(WolphaSymbol.NON_STARTER_CHARACTERS);
//        chars.addAll(WolphaSymbol.LOG_BASE);
//        chars.addAll(WolphaSymbol.OPEN_PARENTHESIS);
//        chars.addAll(WolphaSymbol.CLOSE_PARENTHESIS);
//        assertEquals(WolphaSymbol.VALID_CHAR, chars);
//    }
//
//    @Test
...
//    @Test
//    public void decimal() {
//        assertEquals(BigDecimal.ONE, WolphaCalculator.calculate(".1/.1"));
//        assertEquals(BigDecimal.ONE, WolphaCalculator.calculate("0.1/0.1"));
//        assertEquals(BigDecimal.ONE, WolphaCalculator.calculate(".1/0.1"));
//    }
//
//    @Test
